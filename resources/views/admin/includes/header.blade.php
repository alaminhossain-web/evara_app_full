    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            @endif
                    ...
                    <style>
                        /* Apply 100px left margin on medium devices (768px to 991px) */
            ...
            <div class="main-header d-none d-md-block d-xl-block ms-xl-3" id="mm">
                <a href="{{ route('home') }}" class="btn btn-success"><i class="fa fa-globe fa-2x"></i></a>
